...
export class TypeGenVisitor {
  ...
  visit(documentNode: DocumentNode, { sourceWriteHelper }: VisitOption) {
    ...
    visit(documentNode, {
      OperationDefinition: {
        ...
        leave: node => {
          sourceWriteHelper.pushStatement(
          ...
          // TODO Call back back addon function to push additional statement for result and variable types
      ...
      FragmentDefinition: {
        ...
        leave: node => {
          sourceWriteHelper.pushStatement(
            this._createTsTypeDeclaration(node.name.value, resultFieldElementStack.consume()),
          );
          // TODO Call back addon's function to push additional statement for fragment definition type
          parentTypeStack.consume();
        },
      },
      FragmentSpread: {
    ...
    // TODO Call back addon's function to push additional statement for whole output file. (e.g. some import statement)
    sourceWriteHelper.writeLeadingComment('eslint-disable');
    sourceWriteHelper.writeLeadingComment('This is an autogenerated file. Do not edit this file directly!');
    return sourceWriteHelper.toSourceFile();
  }
  ...
  private _createTsTypeNodeFromScalar(fieldType: GraphQLScalarType) {
    switch (fieldType.name) {
      ...
      default:
        // TODO Call back addon's function to create custom scalar type
